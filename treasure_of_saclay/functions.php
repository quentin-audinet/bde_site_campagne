...
function listHints($team) {
    ...
    $hints = array("Avant de descendre les escaliers de l’enfer, Loys Petitjehan a réussi à laisser un dernier message, à jeter une dernière bouteille à la mer. Retrouvez-le !",
        " Au plaisir de Dieu 009", "RIP 1925 - 2017 602", "Un ancien compagnon de Petitjehan, un dénommé Perrin, fut exécuté là où se dresse aujourd'hui la cour de l'X, et a perdu, en même temps que la vie, son prénom. Désespérée, son âme erre en attendant de le retrouver. Rendez-le-lui, il saura vous récompenser (en vrai, la première lettre ça devrait passer).",
...
function checkCode($num, $code, $team) {
    include "../db/db_connect.php";
    //$table_lettres = ;
    $table_code = array("1" => "101", "2" => "103", "3" => "15", "4" => "24", "5" => "32", "6" => "29", "7" => "J", "8" => "born to be alive", "9" => "22", "10" => "33", "11" => "11", "12" => "23", "13" => "21", "14" => "1");
